...
module.exports = {
  // Project options.
  projectURL: 'https://missile-threat.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
  ...
  // Translation options.
  textDomain: 'missilethreat', // Your textdomain here.
  translationFile: 'missilethreat.pot', // Name of the translation file.
  translationDestination: './languages', // Where to save the translation files.
  packageName: 'CSIS iLab', // Package name.
  bugReport: 'https://github.com/CSIS-iLab/missile-defense', // Where can users report bugs.
