...
if ( ! function_exists( 'missilethreat_get_svg' ) ) {
	/**
	 ...
	 */
	function missilethreat_get_svg( $icon ) {
		return '<svg class="icon icon-' . $icon . '"><use xlink:href="#icon-' . $icon . '"></use></svg>';
	}
}

if ( ! function_exists( 'missilethreat_get_svg_icons' ) ) {
	/**
	 * Get Icon SVG
	 * Get and output icon SVG to reference icons as symbols.
	 *
	 */
	function missilethreat_get_svg_icons() {
