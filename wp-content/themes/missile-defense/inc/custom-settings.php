...
function missiledefense_admin_init_section_homepage() {
	...
	add_settings_field(
		'missiledefense_hpFeaturesPosts_limit',
		'Home Page Featured Items Post Limit',
		'missiledefense_text_callback',
		'missiledefense-options-page',
		'missiledefense_settings_section_homepage',
		array( 'missiledefense_hpFeaturesPosts_limit' )
	);

	add_settings_field(
		'missiledefense_hpNewsPosts_limit',
		'Home Page News Articles Post Limit',
		'missiledefense_text_callback',
		'missiledefense-options-page',
		'missiledefense_settings_section_homepage',
		array( 'missiledefense_hpNewsPosts_limit' )
	);
 ...
 */
function missiledefense_text_callback( $args ) {
