...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'missiledefense' ); ?></a>
        	...
        	<div class="row">
	          	<div class="navbar-header">
		            <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">
		            	<img src="/wp-content/themes/missile-defense/img/missiledefense-logo.svg" class="logo" />
		            </a>
