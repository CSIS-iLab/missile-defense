		...
		<div id="content" role="main" class="span8 offset2" style="margin-top:30px;">
			...
			?>
				...
				?>
					...
					<article class="post">
						...
						<div class="meta clearfix">
							...
							<div class="tags"><?php echo get_the_tag_list( 'Associated Tags: &nbsp;', '&nbsp;' ); // Display the tags this post has, as links separated by spaces and pipes ?></div>
						</div><!-- Meta -->
				...
				<div id="pagination" class="clearfix">
					<div class="past-page"><?php previous_posts_link( 'next' ); // Display a link to  newer posts, if there are any, with the text 'newer' ?></div>
					<div class="next-page"><?php next_posts_link( 'previous' ); // Display a link to  older posts, if there are any, with the text 'older' ?></div>
				</div><!-- pagination -->
